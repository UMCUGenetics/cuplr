...
annotateComplexSVs <- function(df, verbose=F){
   #df=df_complex[df_complex$SampleId=='CPCT02140089T',]
...
extractContextsSvLinx <- function(
   ...
   #vis.sv.data.path='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/analysis/Arne/HMF_linx/sv-linx2/181114_HMFregCPCT_FR16967511_FR15580487_CPCT02140089/sv-linx/CPCT02140089T.linx.vis_sv_data.tsv'
   #vis.sv.data.path='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/analysis/Arne/HMF_linx/sv-linx2/160805_HMFregCPCT_FR03631940_FR12244699_CPCT02010373/sv-linx/CPCT02010373T.linx.vis_sv_data.tsv'
   #df=vis_sv_data[vis_sv_data$SampleId=='CPCT02140089T',]
