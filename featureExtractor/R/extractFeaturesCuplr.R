...
extractFeaturesCuplr <- function(
   ...
   if(F){
      ...
      in.dir='/Users/lnguyen/hpc/cuppen/projects/P0013_WGS_patterns_Diagn/CUPs_classifier/processed/features/_all/01_HMF_PCAWG_full/output/CPCT02010003T/symlinks/'
