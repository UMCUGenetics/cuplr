...
We can see that sample DO51095 is a prostate cancer sample, with and this prediction is supported by
this sample having a TMPRSS2-ERG fusion, a well-known prostate cancer event.

In cases where the probabilities are more uncertain, more feature contribution panels corresponding
to the top predicted classes will be shown, which will further aid in determining the cancer type.
