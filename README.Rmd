...
tumor location with an accuracy of ~0.88. Performance was assessed by 15-fold cross-validation as 
...
* `nmf`: wrapper around NNLM package for non-negative matrix factorization for generating regional mutational density signatures
