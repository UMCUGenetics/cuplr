...
tumor location with an accuracy of 0.90 based on cross-validation and 0.89 based on predictions on
a held out test set.
...
For now, please refer to the paper on bioRxiv. Once the paper is published, this link will be updated.
