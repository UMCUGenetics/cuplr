...
getGeneFusions <- function(
   ...
   #linx.fusion.path='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/analysis/Arne/HMF_linx/sv-linx2/180502_HMFregCPCT_FR17754889_FR16981800_CPCT02020731/sv-linx/CPCT02020731T.linx.fusion.tsv'
   #linx.fusion.path='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/analysis/Arne/HMF_linx/sv-linx2/161118_HMFregCPCT_FR12244404_FR13272005_CPCT02070036/sv-linx/CPCT02070036T.linx.fusion.tsv'
   #linx.fusion.path='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/analysis/Arne/HMF_linx/sv-linx2/160725_HMFregCPCT_FR12244679_FR10302566_CPCT02010351/sv-linx/CPCT02010351T.linx.fusion.tsv'
   ...
   if(nrow(fusions)!=0){
      ...
      out <- structure(
         as.integer(gene_fusion_whitelist %in% fusions$new_name),
         names=gene_fusion_whitelist
      )
      
   } else {
      out <- structure(
         rep(0, length(gene_fusion_whitelist)),
         names=gene_fusion_whitelist
      )
   }
