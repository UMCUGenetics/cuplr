...
getViralInsertions <- function(
   ...
   #linx.viral.inserts.path='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/analysis/Arne/HMF_linx/sv-linx/160830_HMFregCPCT_FR12254146_FR10304572_CPCT02020356/sv-linx/CPCT02020356T.linx.viral_inserts.tsv'
   ...
   counts <- structure(rep(0,length(counts)), names=counts)
   ...
   if(tag.features){
      names(out) <- paste0('viral_ins.',names(out))
   }
   return(out)
}
