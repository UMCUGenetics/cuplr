...
getCytoband <- function(df, cytobands.path=CYTOBANDS, greedy.multi.match=F, verbose=F){
   #df=read.delim('/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104/data/somatics/160704_HMFregCPCT_FR10301986_FR12244591_CPCT02020306/CPCT02020306T.purple.cnv.somatic.tsv')
   #df=df[,1:3]
   colnames(df)[1:3] <- c('chrom','start','end')
