...
model_dir <- paste0(base_dir,'/CUPs_classifier/processed/cuplr/cuplr/models/0.21b_DR104-update5_pcawgSoftFilt2_clonal/')
...
df_features <- read.delim(
   paste0(base_dir,'/CUPs_classifier/processed/features/_all/10_DR104-update5_pcawgSoftFilt2_clonal/all_features.txt.gz'),
   check.names=F
)
